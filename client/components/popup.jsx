    ...
    populateDate(day, month, year) {
        if(arguments.length === 0) {
            ...
            if (this.state.checkIn === '') {
                ...
                var checkIn = this.state.checkIn.split('/');
                if(checkIn[2] < year || (Number(checkIn[2]) === year && checkIn[0] < mm) || (Number(checkIn[2]) === year && checkIn[0] === mm && checkIn[1] < dd)) {
            ...
            <div id = 'booking-container'>
                ...
                <form onSubmit = {this.handleSubmit}>
                    ...
                    <div style = {{display: this.state.calendarShow}}>
                        <Calendar populateDate = {this.populateDate}/>
                    </div>
